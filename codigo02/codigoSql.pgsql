...
SELECT aluno_nome AS aluno, turma, nota FROM notas_alunos WHERE nota >= 70;

SELECT aluno_nome AS aluno, turma, nota FROM notas_alunos WHERE disciplina = 'Matematica' AND nota >= 50;
