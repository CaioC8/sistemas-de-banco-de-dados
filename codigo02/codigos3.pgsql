...
SELECT venda_id, produto_id, valor_unitario FROM vendas_itens WHERE produto_id = 1;

SELECT venda_id, produto_id, valor_unitario, data_venda FROM vendas_itens WHERE venda_id = 2001;

SELECT venda_id, produto_id, valor_unitario, valor_unitario * 1.10 AS valor_final FROM vendas_itens WHERE venda_id = 2001;
...
SELECT * FROM vendas_itens WHERE produto_id IN (1, 2, 3) ORDER BY produto_id ASC;

SELECT venda_id, SUM(valor_unitario) AS total_venda FROM vendas_itens GROUP BY venda_id ORDER BY venda_id ASC;